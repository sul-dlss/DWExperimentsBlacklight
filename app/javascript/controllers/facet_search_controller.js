...
// Connects to data-controller="facet-search"
// Drives the sidebar facet search box: typing loads filtered results into the
// turbo frame, and arrow keys navigate the resulting links.
export default class extends Controller {
  ...
  search() {
    ...
    uri.searchParams.set("query_fragment", this.inputTarget.value)
  ...
  addLoadingPlaceholder() {
    ...
    placeholder.classList.add("text-center", "p-3", "fst-italic", "ms-4", "facet-search-results")
